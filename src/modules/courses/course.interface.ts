...
export interface IContent extends Document {
  _id?: mongoose.Schema.Types.ObjectId; // MongoDB ObjectId for content
...
export interface IModule extends Document {
  _id?: mongoose.Schema.Types.ObjectId; // MongoDB ObjectId for the module
...
// IQueries interface for course comments
...
export interface ICourse extends Document {
  ...
  queries?: IQueries[]; // Array of comments for the course
